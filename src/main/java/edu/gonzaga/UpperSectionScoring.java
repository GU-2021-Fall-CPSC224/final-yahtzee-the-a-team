...
public class UpperSectionScoring {
    ...
    /**
     * Retrieves a list of integers where the value at each index corresponds to the quantity of die with a
     * face up value of i+1. For example, if the hand has two 4's the value at index 3 would equal 2.
     *
